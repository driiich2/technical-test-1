...
class BoardingCardStringifierTest extends TestCase
{
    public function testBoardingCardStringifier()
    {
        ...
        $this->assertStringContainsString('From Tokyo, take train , 6, to Osaka. Seat in 35. Small baggages only.', $result[0]);
        $this->assertStringContainsString('From London, take train , 3, to Paris. Seat in 27C.', $result[1]);
        $this->assertStringContainsString('From New York, take flight , A12, to London. Seat in 12A. Baggage will we automatically transferred from your last leg. Be an hour early for the flight.', $result[2]);
        $this->assertStringContainsString('From Lyon, take flight , B10, to Tokyo. Seat in 13A. No Baggage.', $result[3]);
